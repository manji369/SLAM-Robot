...
void loop() {
  ...
  if(Serial.available() > 0) {
    ...
    switch(incomingByte){
      ...
      spd11 = spd11 + rat*cnt1;
      spd21 = spd11;
      mov_direction(0,spd11,0,spd21);
      digitalWrite(led,HIGH);
      delay(del1);
      }
      delay(del2);
      mov_direction(0,0,0,0);
      break;
      case 66:
      rat = (spd1-spd11)/20;
      for(int cnt1 = 1;cnt1 < 20; cnt1++){
      ...
      del1 = Serial.parseInt();
      del2 = Serial.parseInt();
      del3 = Serial.parseInt();
      spd2 = spd1;
      break;
      case 77:
      M11 = Serial.parseInt();
